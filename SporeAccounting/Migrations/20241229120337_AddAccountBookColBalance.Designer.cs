...
namespace SporeAccounting.Migrations
{
    ...
    [Migration("20241229120337_AddAccountBookColBalance")]
    partial class AddAccountBookColBalance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SporeAccounting.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Abbreviation = "CNY",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1462),
                        ...
                        new
                        {
                            ...
                            Abbreviation = "USD",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1470),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "美元"
                        },
                        new
                        {
                            ...
                            Abbreviation = "EUR",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1476),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "欧元"
                        },
                        new
                        {
                            ...
                            Abbreviation = "JPY",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1483),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "日元"
                        },
                        new
                        {
                            ...
                            Abbreviation = "GBP",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1489),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "英镑"
                        },
                        new
                        {
                            ...
                            Abbreviation = "MOP",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1499),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "澳门币"
                        },
                        new
                        {
                            ...
                            Abbreviation = "HKD",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1506),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "港元"
                        },
                        new
                        {
                            ...
                            Abbreviation = "KRW",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1513),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "韩圆"
                        },
                        new
                        {
                            ...
                            Abbreviation = "TWD",
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1519),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "新台币"
                        });
            ...
            modelBuilder.Entity("SporeAccounting.Models.IncomeExpenditureClassification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CanDelete = false,
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(1436),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            Name = "其他",
                            Type = -1
            ...
            modelBuilder.Entity("SporeAccounting.Models.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CanDelete = false,
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(380),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CanDelete = false,
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(392),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            IsDeleted = false,
                            RoleName = "Consumer"
                        });
            ...
            modelBuilder.Entity("SporeAccounting.Models.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CanDelete = false,
                            CreateDateTime = new DateTime(2024, 12, 29, 20, 3, 36, 731, DateTimeKind.Local).AddTicks(471),
                            CreateUserId = "b47637e2-603f-4df0-abe9-88d70fa870ee",
                            Email = "admin@miaoshu.xyz",
                            IsDeleted = false,
                            Password = "bfiw2lW351IUdHdBf5Le3TLXHxWz9cH7Q2ONRcGnU4w=",
                            PhoneNumber = "",
                            RoleId = "cef80881-fe89-4b1f-85ad-83184777d61b",
                            Salt = "0c4dba6d7e04479eae201b8c7d52f2ed",
                            UserName = "admin"
                        });
                });
