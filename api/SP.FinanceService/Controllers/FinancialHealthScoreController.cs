...
public class FinancialHealthScoreController : ControllerBase
{
    ...
    /// </summary>
    /// <returns>改善建议列表</returns>
    [HttpGet("suggestions/all")]
    public async System.Threading.Tasks.Task<ActionResult<List<FinancialSuggestionResponse>>> GetSuggestionsForAll()
    {
        var result = await _service.GetSuggestionsForAllAccountBooksAsync();
        return Ok(result);
    }
}
