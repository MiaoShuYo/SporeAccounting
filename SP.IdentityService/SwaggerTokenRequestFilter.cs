                    ...
                    ["application/json"] = new OpenApiMediaType 
                    {
                        Schema = new OpenApiSchema 
                        {
                            ...
                            Properties = new Dictionary<string, OpenApiSchema> 
                            {
                                ...
                                ["token_type"] = new OpenApiSchema { Type = "string", Description = "令牌类型", Example = new OpenApiString("Bearer") },
                                ["expires_in"] = new OpenApiSchema { Type = "integer", Description = "有效期（秒）", Example = new OpenApiInteger(1800) },
